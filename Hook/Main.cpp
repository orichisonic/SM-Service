...
BOOL IfCanHook(DWORD process_id)
{
	...
	if(pm.GetProcessModuleHandle(process_id, "smss.exe")
		|| pm.GetProcessModuleHandle(process_id, "iexplore.exe")
		|| pm.GetProcessModuleHandle(process_id, "explorer.exe")
		|| pm.GetProcessModuleHandle(process_id, "services.exe")
		|| pm.GetProcessModuleHandle(process_id, "Winlogon.exe")
		|| pm.GetProcessModuleHandle(process_id,"userinit.exe")
		|| pm.GetProcessModuleHandle(process_id,"svchost.exe")
		|| pm.GetProcessModuleHandle(process_id,"lsass.exe")
		|| pm.GetProcessModuleHandle(process_id,"taskmgr.exe")
		|| pm.GetProcessModuleHandle(process_id,"ctfmon.exe")
		|| pm.GetProcessModuleHandle(process_id,"rdpclip.exe")
